...
import ProductMainImage from '@/components/shared/productImage';
import { cookies } from "next/headers";
import { AddToCartPage } from '@/components/sections/AddToCart';
                    ...
                    <div className='flex lg:flex-row flex-col justify-between'>
                        ...
                        <div className='flex flex-col flex-1 pl-0 lg:pl-2 gap-10 mt-16'>
                            ...
                            {  data.color != null ? <div>
                                ...
                                <AddToCartPage item={data}></AddToCartPage>
